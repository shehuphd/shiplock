...
Last updated: 2026-09-02 11:14:37 UTC
...
| `_style.py` | The banned-word list (`BANNED_WORDS`) and the word-boundary, case-sensitive matcher (`find_banned`, `effective_words`). Excluded from shiplock's own sweep since it must name the words. |
